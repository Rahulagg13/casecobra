...
interface OrderRecievedEmailProps {
...
const OrderReceivedEmail = ({
  ...
  orderDate,
  orderId,
}: OrderRecievedEmailProps) => {
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://casecobra-eta-wheat.vercel.app/";
  return (
    <Html>
      <Head />
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                ...
                this email, we won't be able to see it. All the data used is
                fake.. )
              </Text>
            </Row>
            <Row>
