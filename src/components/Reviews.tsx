...
const ReviewGrid = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative select-none -mx-4 grid h-[49rem] max-h-[150vh] gris-cols-1 items-start gap-8 overflow-hidden px-4 sm:mt-20 md:grid-cols-2 lg:grid-cols-3"
    >
      {isInView ? (
        <>
          <ReviewColumn
