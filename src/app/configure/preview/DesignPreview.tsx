...
import { COLOR, MODEL } from "@/validators/option-validator";
...
const DesignPreview = ({ configuration }: DesignPreviewProps) => {
  ...
  const tw = COLOR.find((supportedColor) => supportedColor.value === color)?.tw;
  ...
  return (
    <>
      ...
      <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
        <div className=" mb-20 pointer-events-none select-none md:col-span-4 lg:col-span-3 md:row-span-2 md:row-end-2">
          <Phone
