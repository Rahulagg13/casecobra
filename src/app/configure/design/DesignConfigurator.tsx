...
import { saveConfigProp, saveConfig as _saveConfig } from "./actions";
...
const DesignConfigurator = ({
  ...
  const { mutate: saveConfig,isPending } = useMutation({
    ...
    mutationFn: async (args: saveConfigProp) => {
  ...
  const [options, setOptions] = useState<{
    ...
    material: (typeof MATERIALS.options)[0];
    finish: (typeof FINISHES.options)[0];
  }>({
    color: COLOR[0],
      ...
      <div className="h-[37.5rem] w-full col-span-full lg:col-span-1 flex flex-col bg-white ">
        <ScrollArea className="relative flex-1 overflow-auto">
          ...
          <div className="px-8 pb-12 pt-8">
            ...
            <div className="w-full h-px bg-zinc-600 my-6" />
